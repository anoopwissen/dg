    ...
    "Data Infrastructure & SLA Management": {
        ...
        "questions": {
            "Is the data feed frequency for this dataset formally defined, documented, and aligned with BCBS-239 reporting needs?": {
                "options": ["Initial", "Developing", "Defined", "Managed", "Optimised"],
                "guidance": "Frequency (real-time, daily, T+1) should be approved by business and risk stakeholders"
            },
            "Are SLAs defined and monitored for data availability, timeliness, and completeness for this dataset?": {
                "options": ["Initial", "Developing", "Defined", "Managed", "Optimised"],
                "guidance": "SLAs should be measurable, tracked, and reviewed regularly"
            },
            "Is end-to-end data latency (source to reporting layer) measured, monitored, and reported?": {
                "options": ["Initial", "Developing", "Defined", "Managed", "Optimised"],
                "guidance": "Latency thresholds should be defined with alerts for breaches"
            },
            "Are SLA or latency breaches automatically detected, logged, and remediated with audit evidence?": {
                "options": ["Initial", "Developing", "Defined", "Managed", "Optimised"],
                "guidance": "Breaches should trigger alerts, RCA, and tracked remediation"
            },
            "Has data governance been formally applied to this dataset (owner, steward, lineage, DQ rules)?": {
                "options": ["Initial", "Developing", "Defined", "Managed", "Optimised"],
                "guidance": "Dataset should be catalogued with ownership, lineage, and quality controls"
            },
        },
    },
...
def generate_recommendations(section_scores):
    ...
    for section, score in section_scores.items():
        if score < 70:
            ...
            elif section == "Data Infrastructure & SLA Management":
                rec["actions"] = [
                    "Document and approve data feed frequencies",
                    "Define measurable SLAs for availability and timeliness",
                    "Implement automated latency monitoring and alerting",
                    "Establish breach detection and remediation workflows"
                ]
...
def render_landing_page():
    ...
    with col1:
        ...
        - **Governance & Ownership** (15%)
        - **Data Infrastructure & SLA Management** (20%)
        - **Data Quality & Controls** (25%)
        - **Lineage & Traceability** (15%)
        - **BCBS-239 Specific Controls** (15%)
...
def main():
    ...
    with st.sidebar:
        ...
        if st.session_state.started:
            ...
            st.markdown("""
            This tool evaluates your organization's readiness across six key 
